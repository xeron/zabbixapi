{<img src="https://secure.travis-ci.org/xeron/zabbixapi.png?branch=master" alt="Build Status" />}[http://travis-ci.org/xeron/zabbixapi]
...
* Zabbix Project Homepage -> http://www.zabbix.com
